...
A complete Python example of accessing and plotting NASADEM data in COG format is available in the accompanying [sample notebook (COG)](https://nbviewer.jupyter.org/github/microsoft/AIforEarthDataSets/blob/main/data/nasadem-cog.ipynb).

A complete Python example of accessing and plotting NASADEM data in NetCDF format is available in the accompanying [sample notebook (NetCDF)](https://nbviewer.jupyter.org/github/microsoft/AIforEarthDataSets/blob/main/data/nasadem-nc.ipynb).
