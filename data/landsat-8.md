...
* `[sensor]` is one of "mss" (Landsat 1-4), "tm" (Landsat 4-5), "etm" (Landsat 7), or "oli-tirs" (Landsat 8) (always "oli-tirs" for this collection, for this Landsat 8 <u>o</u>perational <u>l</u>and <u>i</u>mager and <u>t</u>hermal <u>i</u>nfra<u>r</u>ed <u>s</u>sensor)
...
<img src="https://ai4edatasetspublicassets.blob.core.windows.net/assets/aod_images/landsat_800w.png" style="width:500px;"><br/><span style='font-size:80%'>Natural-color rendering (Landsat 8 bands 4/3/2) of an area near Auckland, New Zealand.</span>
